                                            ...
                                            <tbody>
                                                ...
                                                if(!empty($getTest))
                                                {
													...
													{ ?>
                                                      ...
                                                      <!-- <td><?php echo anchor('Test_controller/delete_test?test_id='.$value['test_id'], 'DELETE');?></td> -->
                                                      <!-- <td><?php echo anchor('Test_controller/update_test?test_id='.$value['test_id'], 'UPDATE');?></td> -->
														</tr>
												<?php	}
                                                }
                                                ?>
